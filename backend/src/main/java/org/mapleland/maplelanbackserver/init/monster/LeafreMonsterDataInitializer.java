...
public class LeafreMonsterDataInitializer {
    ...
    public void initAquariumMonsterData() {
        ...
        monsterDropItemRepository.saveAll(List.of(
                MonsterDropItem.builder()
                        .mapName("미나르 숲:불과 어둠의 전장") // << --- 여기 수정해야함
                        .itemName("레드 크리븐")
